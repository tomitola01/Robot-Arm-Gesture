...
Left Hand Control:
-  Select claw ![](./d_sign.png)
- Select forearm ![](./thumb_up.png)
- Select main arm ![](./y_sign.png)
- Halt movement ![](./stop_hand.png)

Right Hand Control:
- Open claw/move arm up ![](./stop_hand.png)
- Close claw/move arm down ![](./close_hand.jpg)
